...
export default function Carousel({ heroes, activeId }: IProps) {
  ...
  const voicesAudio: Record<string, HTMLMediaElement> = useMemo(
    () => ({
  ...
  const handleDragEnd = (e: React.DragEvent<HTMLDivElement>) => {
    ...
    handleChangDragTouch(e.clientX);
  };
  ...
  const handleTouchEnd = (e: React.TouchEvent<HTMLDivElement>) => {
    ...
    handleChangDragTouch(e.changedTouches[0].clientX);
  };

  const handleChangDragTouch = (clientX: number) => {
